...
> - [프론트엔드 프로그래머(경력)](#front-end-programmer)
...
## <span id="front-end-programmer">웹 프론트엔드 프로그래머(경력)</span>

오마이랩이 정규직 경력 웹 프론트엔드 프로그래머를 채용합니다.
...
1. **개발 경력**<br />하나 이상의 웹 프론트엔드 프레임워크(Angular, React, Vue.js, etc...)를 사용한 **3년 이상**의 개발 경력이 필요합니다.
