...
> **채용 부문** (상시 업데이트됩니다)
>
> - [서버 프로그래머(경력)](#server-programmer)
> - [프론트엔드 프로그래머(신입/경력)](#front-end-programmer)
...
## <span id="server-programmer">서버 프로그래머(경력)</span>

오마이랩이 정규직 경력 서버 프로그래머를 채용합니다.
...
1. **시스템 고도화**<br />효과적인 기법을 도입해 오마이랩의 새로운 시스템을 구현하고 지속적으로 고도화 합니다. 적정 수준의 기술과 아키텍팅을 통해 지속 가능한 클라우드 기반 분산 시스템을 구축합니다.
...
## <span id="front-end-programmer">웹 프론트엔드 프로그래머(신입/경력)</span>

오마이랩이 정규직 신입 혹은 경력 웹 프론트엔드 프로그래머를 채용합니다.
...
1. **개발 경력**<br />경력의 경우, 하나 이상의 웹 프론트엔드 프레임워크(Angular, React, Vue, etc...)를 사용한 **3년 이상**의 개발 경력이 필요합니다.
1. **HTML/CSS/JavaScript**<br />웹 마크업과 JavaScript를 이해하며, 이에 따르는 기법들을 알고 있어야 합니다.
1. **웹 API 연동 경험**<br />웹 API 명세를 가지고 웹 클라이언트를 구현/운영해 본 경험이 있어야 합니다.
...
1. **비동기식 요청 처리, 부분적인 페이지 업데이트, AJAX에 대한 이해**
1. **브라우저 렌더링 행위 및 성과에 대한 이해**
1. **테스트 주도 개발(Test-Driven Development) 경험**
1. **도메인 주도 설계(Domain-Driven Design) 이해**
1. **지속 배포(Continuous Deployment) 경험**
1. **소규모(2~4인) 팀을 이끌어 본 경험**
...
1. **웹 클라이언트 개발**<br />적정 수준의 기술과 아키텍팅을 통해 브라우저 호환성을 확보한 오마이랩 시스템의 웹 클라이언트를 구현하고 지속적으로 고도화 합니다.
1. **프로세스 자동화**<br />제품 개발의 민첩함과 안정성을 높이기 위해 가능한 많은 응용프로그램 생명주기 절차를 자동화 합니다.
1. **지식 공유**<br />학습과 경험을 통해 습득한 기술 지식과 업무 지식을 가시적 산출물로 환원하고 조직 내부에, 그리고 때로는 조직 외부에, 전파합니다.
