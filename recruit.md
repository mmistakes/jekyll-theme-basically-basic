...
layout: page
introduction: "오마이랩은 전통적인 온라인 여행사의 모습에서 벗어나 기술 기반의 여행 서비스 기업으로 도약합니다. 이 변화와 성장을 함께할 인재를 모십니다."
...
(주)오마이랩은 전통적인 온라인 여행사의 모습에서 벗어나 기술 기반의 여행 서비스 기업으로 거듭나고 도약하기 위해 기존의 IT 개발지원팀을 제품개발본부로 재편하고 투자를 적극적으로 늘리고 있습니다. 이에 2017년 5월 CTO를 선임하고, 기존의 시스템을 고도화하고 신규 기능을 개발하고 있습니다.

세계 최고 수준의 IT 기술을 가진 여행 서비스업의 R&D 조직을 목표로 2018년에는 국내 1위의 기술력을 가진 여행 서비스 기업이 될 것입니다. (주)오마이랩 제품개발본부는 상기를 달성하기 위해 **지속 가능한 높은 수준의 프로세스와 시스템을 구축하기 위해 노력하고 있으며 변화와 성장을 함께할 인재를 모십니다.**

## (주)오마이랩이 기술인력을 채용합니다

> **채용 부문** (상시 업데이트됩니다)
>
> 1. [서버 프로그래머(정규직 경력)](#server-programmer)
...
CI(Continuous Integration) 기반의 통합 DevOps 서비스를 사용하여 개발 업무 집중도를 높이려는 지속적 노력을 하고 있습니다. 업무 생산성 향상을 위해 애자일 방법론을 비즈니스 환경과 조직의 리소스에 맞게 지속적으로 튜닝하고 있습니다. 개발 환경에 적합한 고사양의 MacBook Pro 나 Windows 랩탑과 모니터를 제공합니다.
...
#### 긍정적 자세
스타트업은 언제 어떤 도전에 맞닥칠지 모릅니다. 개선을 도출하려는 비판적 자세와 '우린 안돼'라는 부정적 자세는 분명히 다릅니다. 우리는 긍정적 태도로 목적 달성을 위해 개선에 개선을 거듭하는 사람들입니다.
...
#### 근무지
서울특별시 중구 정동길 14 오송빌딩 2층 [[지도보기](http://naver.me/G6h4IfAi){:target="_blank"}]
...
(주)오마이랩 서버 시스템은 .NET/ Python/ Microsoft Azure/ AWS 등의 기술을 사용합니다.
